...
module.exports = function(msg){
  try{
    ...
    var userinfo = JSON.parse(fs.readFileSync('./util/modules/servers/userinfo.json', 'utf8'));
    ...
    fs.writeFile('./util/modules/servers/userinfo.json', JSON.stringify(userinfo, null, "\t"));
    return true;
  } catch(err){
    return false;
  }
